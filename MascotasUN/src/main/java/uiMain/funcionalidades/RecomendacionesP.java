...
public class RecomendacionesP {
	public static void funcionalidad() {
		...
		//Se pregunta al vendedor que usuario requiere la recomendacion(El ID, o el nombre)
		System.out.println("¿Desea una recomendación personalizada");
        ...
        do {
            ...
            case 1:
        		...
        		if (Tienda.getUsuarios().containsKey(opcion2)) {
        			usuario = Tienda.getUsuarios().get(opcion2);
