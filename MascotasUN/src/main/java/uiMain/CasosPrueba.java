...
public class CasosPrueba {
	...
	vendedores.add(new Vendedor(46785214, "Juan Pablo Arcila", "jpardilla@email.com", 4478514, "Juan Pablo Arcila", "holi12"));
	vendedores.add(new Vendedor(13205481, "Roberto Barrientos", "rbarriendo@email.com", 4905873, "Roberto Barrientos", "adios13"));
	vendedores.add(new Vendedor(119258647, "Laura Vanegas", "lavanega@email.com", 3158647, "Laura Vanegas", "lau1245"));
