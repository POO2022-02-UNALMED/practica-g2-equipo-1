...
class Inicio(Frame, Tk):
    ...
    def cambiarImagenesSistema(self, e=None):
        ...
        if self._numeroImagenesSistema == 0:
            imagen_sistema = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/capturas_sistema/sistema1.png').resize((300,225), Image.ANTIALIAS))
        elif self._numeroImagenesSistema == 1:
            imagen_sistema = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/capturas_sistema/sistema2.png').resize((300,225), Image.ANTIALIAS))
        elif self._numeroImagenesSistema == 2:
            imagen_sistema = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/capturas_sistema/sistema3.png').resize((300,225), Image.ANTIALIAS))
        elif self._numeroImagenesSistema == 3:
            imagen_sistema = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/capturas_sistema/sistema4.png').resize((300,225), Image.ANTIALIAS))
        else :
            imagen_sistema = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/capturas_sistema/sistema5.png').resize((300,225), Image.ANTIALIAS))
    ...
    def cambiarInfoDesarrolladores(self, e=None):
        ...
        if self._numeroInicio == 0 :
            python_imagen1 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_hina/hina1.jpg').resize((300,225), Image.ANTIALIAS))
            self.imagen1.image = python_imagen1
            self.imagen1.configure(image = python_imagen1)

            python_imagen2 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_hina/hina2.jpg').resize((300,225), Image.ANTIALIAS))
            self.imagen2.image = python_imagen2
            self.imagen2.configure(image = python_imagen2)

            python_imagen3 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_hina/hina3.jpg').resize((300,225), Image.ANTIALIAS))
            self.imagen3.image = python_imagen3
            self.imagen3.configure(image = python_imagen3)

            python_imagen4 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_hina/hina4.jpg').resize((300,225), Image.ANTIALIAS))
            self.imagen4.image = python_imagen4
            self.imagen4.configure(image = python_imagen4)

        elif self._numeroInicio == 1:
            python_imagen1 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_ale/ale1.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen1.image = python_imagen1
            self.imagen1.configure(image = python_imagen1)

            python_imagen2 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_ale/ale2.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen2.image = python_imagen2
            self.imagen2.configure(image = python_imagen2)

            python_imagen3 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_ale/ale3.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen3.image = python_imagen3
            self.imagen3.configure(image = python_imagen3)

            python_imagen4 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_ale/ale4.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen4.image = python_imagen4
            self.imagen4.configure(image = python_imagen4)

        elif self._numeroInicio == 2:
            python_imagen1 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_anna/anna1.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen1.image = python_imagen1
            self.imagen1.configure(image = python_imagen1)

            python_imagen2 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_anna/anna2.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen2.image = python_imagen2
            self.imagen2.configure(image = python_imagen2)

            python_imagen3 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_anna/anna3.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen3.image = python_imagen3
            self.imagen3.configure(image = python_imagen3)

            python_imagen4 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_anna/anna4.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen4.image = python_imagen4
            self.imagen4.configure(image = python_imagen4)
            
        elif self._numeroInicio == 3:
            python_imagen1 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_felo/felo1.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen1.image = python_imagen1
            self.imagen1.configure(image = python_imagen1)

            python_imagen2 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_felo/felo2.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen2.image = python_imagen2
            self.imagen2.configure(image = python_imagen2)

            python_imagen3 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_felo/felo3.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen3.image = python_imagen3
            self.imagen3.configure(image = python_imagen3)

            python_imagen4 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_felo/felo4.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen4.image = python_imagen4
            self.imagen4.configure(image = python_imagen4)
            
        elif self._numeroInicio == 4:
            python_imagen1 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_juanjo/juanjo1.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen1.image = python_imagen1
            self.imagen1.configure(image = python_imagen1)

            python_imagen2 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_juanjo/juanjo2.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen2.image = python_imagen2
            self.imagen2.configure(image = python_imagen2)

            python_imagen3 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_juanjo/juanjo3.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen3.image = python_imagen3
            self.imagen3.configure(image = python_imagen3)

            python_imagen4 = Image.PhotoImage(Image.open('./src/interfaz/Imagenes/fotos_juanjo/juanjo4.jpeg').resize((300,225), Image.ANTIALIAS))
            self.imagen4.image = python_imagen4
            self.imagen4.configure(image = python_imagen4)
